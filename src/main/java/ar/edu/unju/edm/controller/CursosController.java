...
public class CursosController {
	...
	public ModelAndView addCurso() {
		EMILIO.info("iiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii0i");
	...
	@PostMapping("/hola")
	public String guardarC (@ModelAttribute("curso") Curso cursoparaguardar, Model model) {
		EMILIO.info("Entrando a hola");
		return "cargarCurso";
	}
	...
	public String saveCurso(@Valid @ModelAttribute("curso") Curso cursoparaguardar, BindingResult resultado, Model model) { //del modelo viene 1 atributo llamado usuario y lo agarra le indica el tipo y un nombre 
		EMILIO.fatal("Entrando a guardar");
	...
	public ModelAndView showCurso() {
		EMILIO.error("LLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLL");
	...
	@PostMapping("/guardarCursoModificado")
	public ModelAndView postEditarCurso(@ModelAttribute ("curso") Curso cursoparamodificar) {  
		EMILIO.error("nnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn");
